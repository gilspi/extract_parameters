...
class ParameterParser:
    def __init__(
        self, file_path: str, ignore_params_loader: IgnoreParamsLoader
    ) -> None:
    ...
    def parse(self) -> List[Dict[str, Optional[float]]]:
        ...
        with open(self.file_path, "r") as file:
            for line in file:
                ...
                if match:
                    name, default_value, units, min_value, max_value, description = (
                        match.groups()
                    )
    ...
    def save_simulation_results(self, input_file: str, directory: str):
        ...
        output_file = os.path.join(
            directory, f"simulation_results_{timestamp}.csv"
        )  # TODO: исправить название гибкое включает название модели
